...
TEST_CASE( "acon2" ){
  GIVEN( "" ){
    WHEN( "" ){
      double T = 0.0255, SZCON = 144.9356, AM = 0.991409, W1 = 0.0555556, PSQ = 1.0;
      ...
      for (size_t i = 0; i < EPS.size(); ++i){ EPS[i] = i*0.00204; }
      ...
      //std::cout << (S2|ranges::view::all) << std::endl;

      REQUIRE( ranges::equal(S2,correctS2,equal) );
